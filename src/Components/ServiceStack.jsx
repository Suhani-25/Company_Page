...
function ServiceStack() {
  ...
  return (
    <div className="bg-white min-h-screen flex flex-col items-center justify-center px-6">
      <h1 className="mt-16 text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-teal-700 animate-textColorChange mb-20 font-custom ">Services We Offer...</h1>

      <div className="grid grid-cols-3 gap-8">
        {/* Full Stack Card */}
        <div 
          className="bg-white p-6 shadow-md cursor-pointer rounded-md hover:bg-gray-200 border-2 border-blue-300 hover:border-blue-500 flex items-center w-56 h-20"
        ...
        {/* Quote Button */}
        <div className="col-span-3 flex justify-center mt-8 mb-12">
          <button
            className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded-full w-64 flex items-center justify-center"
            onClick={() => navigate('/ContactPage')} // Replace with your actual quote page path
          >
            Give a Quote
            <svg
              width="20"
            ...
            >
              <path
                ...
                fill="#FFB6C1" // Updated the color to light pink, change as per your preference
              />
            </svg>
          </button>
        </div>
